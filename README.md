...
> **Neil1454 Windows torrent-integration and automation fork:** this fork adds manual and rules-based sending of RSS torrent links to named qBittorrent, Transmission, Flood, rTorrent/ruTorrent, Deluge, rQBit, and Porla instances. It includes client health/capacity checks, load-balanced routing, guarded cleanup, synchronized per-client send ticks, a proxy connection test, and a one-click light/dark theme switch. See the [feature overview](README-TORRENT-INTEGRATION.md), [automation guide](docs/source/features/torrent-automation.md), [client guide](docs/source/features/torrent-clients.md), [Windows build instructions](BUILD-WINDOWS.md), and [testing guide](TESTING-TORRENT-INTEGRATION.md). This fork publishes an unsigned Windows 10/11 x64 portable test package through [GitHub Actions](https://github.com/Neil1454/rssguard/actions/workflows/torrent-windows-portable.yml); it does not publish a custom installer, Linux package, or macOS package.
...
[![Packaging status](https://img.shields.io/repology/repositories/rssguard)](https://repology.org/project/rssguard/versions)
...
[![GitHub Sponsors](https://img.shields.io/github/sponsors/martinrotter)](https://github.com/sponsors/martinrotter)
