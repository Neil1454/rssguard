...
> **Neil1454 Windows torrent-integration fork:** this fork adds native sending of RSS article torrent links to named qBittorrent, Transmission, Flood, rTorrent/ruTorrent, Deluge, rQBit, and Porla instances. See the [feature overview](README-TORRENT-INTEGRATION.md), [user guide](docs/source/features/torrent-clients.md), [Windows build instructions](BUILD-WINDOWS.md), and [testing guide](TESTING-TORRENT-INTEGRATION.md). This fork currently publishes an unsigned Windows 10/11 x64 portable test package through [GitHub Actions](https://github.com/Neil1454/rssguard/actions/workflows/torrent-windows-portable.yml); it does not publish a custom installer, Linux package, or macOS package.
